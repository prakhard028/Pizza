...
var addToCart = document.querySelectorAll('.addtocart'); // selecting all the buttons and in addToCart we are getting array
...
function updateCart(pizza) // its ajax call, then we use axios
{
  axios__WEBPACK_IMPORTED_MODULE_0___default.a.post('/update-cart', pizza).then(function (res) {
    console.log(res); //  cartCounter.innerHTML=res.data.totalQty;
...
addToCart.forEach(function (btn) {
  btn.addEventListener('click', function (e) {
    ...
    var pizza = JSON.parse(btn.dataset.pizza); // this help us to get data of 
...
__webpack_require__(/*! E:\react workspace\pizza\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! E:\react workspace\pizza\resources\css\app.scss */"./resources/css/app.scss");
